<?php
include("config.php");
$result = mysqli_query($conn,"SELECT * FROM product ORDER BY price ASC");
?>
<!DOCTYPE html>
<html>
 <head>
      ...
      <li><a href="list.php">List</a></li>
       <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li class="active"><a href="ascen.php">Ascending order</a></li>
          <li><a href="desc.php">Descending order</a></li>
        </ul>
      </li>
    </ul>
